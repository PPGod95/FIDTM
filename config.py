...
parser.add_argument('--save_path', type=str, default='results/A_baseline', help='save checkpoint directory')
...
parser.add_argument('--epochs', type=int, default=3 , help='end epoch for training')
...
parser.add_argument('--visual', type=bool, default=False, help='visual for bounding box. ')
parser.add_argument('--resize', type=tuple, default=(1440, 810),
